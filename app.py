...
4. Customise your plot using the options in the sidebar. You can select the color scheme, font style, line thickness, plot dimensions, and more.
5. After customisation, you can download the plot as a PNG file using the download button below the plot.
""")
